				...
				<div class="navbar-header">
					<button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#sidebar-collapse"><span class="sr-only">Toggle navigation</span>
						...
						<ul class="nav navbar-top-links navbar-right">
							<a href="<?php echo base_url('/help') ?>"><img src="<?php echo base_url('assets/img/icons8-ask-question-48.png') ?>" ></a>

						</ul>
						<ul class="nav navbar-top-links navbar-right">
							<li><a href="<?php echo base_url('/dashboard') ?>"><img src="<?php echo base_url('assets/img/statistics.png') ?>" ></a></li>
	...
	$('#tambah').on('click', function() {
		...
		jQuery(function(){
			new Highcharts.Chart({
				...
				title: {
					text: 'Grafik Pemasukan dan Pengeluaran AMCC',
					x: -20
				},
				subtitle: {
					text: currentTime.getFullYear(),
					x: -20
				},
				xAxis: {
